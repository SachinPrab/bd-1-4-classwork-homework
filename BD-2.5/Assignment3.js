...
function filterByPricing(a,b,pricing)
{
...
app.get("/hotels/sort/pricing",(req,res) => {
  ...
  let sortedHotels = hotels.sort((a, b) => filterByPricing(a,b,pricing));
  res.json({ hotels: sortedHotels });
});

function filterByRating(a,b,ratings)
{
...
app.get("/hotels/sort/rating",(req,res) => {
  ...
  let sortedHotels = hotels.sort((a,b) => filterByRating(a,b,ratings));
  res.json({ hotels: sortedHotels });
});

function filterByReview(a,b,reviews)
{
...
app.get("/hotels/sort/reviews",(req,res) => {
  ...
  let sortedHotels = hotels.sort((a,b) => filterByReview(a,b,reviews));
  res.json({ hotels: sortedHotels});
});
...
let country = req.query.country;
  let sortedHotels = hotels.filter((hotel) => filterByCountry(hotel, country));
  res.json({hotels: sortedHotels});
});
...
app.get("/hotels/filter/category",(req,res) => {
  ...
  let sortedHotels = hotels.filter((hotel) => filterByCategory(hotel, category));
  res.json({hotels: sortedHotels});
});
